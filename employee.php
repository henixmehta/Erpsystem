...
<head>
   ...
   <style>
	...
	<!-- <link rel="stylesheet" href="main1.min.css"> -->
                     ...
                     <form>
                        <div class="form-group">
                           <div class="profile-img-edit position-relative">
							   <img src="#" alt="profile-pic" class="theme-color-default-img profile-pic rounded avatar-100">
							   <img src="#" alt="profile-pic" class="theme-color-purple-img profile-pic rounded avatar-100">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="furl" placeholder="Facebook Url" required>
                        </div>
                        <div class="form-group">
