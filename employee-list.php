            ...
            <div class="col-xl-12 col-lg-8">
               ...
               <tbody>                 
                  <?php
                        ...
                        <!-- update -->
                           <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-original-title="Edit" href="update.php?id=<?php echo $row['id']?>">
                           ...
                           <!-- delete button -->            
                           <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"  href="delete.php?id=<?php echo $row['id']?>" >
                              <span class="btn-inner">
