                                            ...
                                            <tbody>
                                                ...
                                                if ($_SESSION['e_role'] == "user") {
                                                    ...
                                                    if (isset($_POST['search'])) {
                                                        ...
                                                        $q = "SELECT * FROM leaves WHERE  s_date LIKE '%$search%' OR e_date LIKE '%$search%' OR leave_type LIKE '%$search%' OR reason LIKE '%$search%' ";
                                                    } else {
                                                ...
                                                ?>
                                                    ...
                                                    if (isset($_POST['search'])) {
                                                        ...
                                                        // Query to search for employees by first name, last name, or team name
                                                        $q = "SELECT * FROM leaves WHERE emp_name LIKE '%$search%' OR s_date LIKE '%$search%' OR e_date LIKE '%$search%' OR leave_type LIKE '%$search%' OR reason LIKE '%$search%' ";
                                                    } else {
                                                        // $q = "select * from leaves where emp_name = '" . $_SESSION['emp_fname'] . "' ";
