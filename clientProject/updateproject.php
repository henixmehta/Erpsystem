...
<?php 
                ...
                if (isset($_POST['sub_btn'])) {
                    ...
                    if (!empty($_FILES['com_img']['name'])) {
                        mysqli_stmt_bind_param($stmt, "sssssssi", $_POST['p_name'], $_POST['p_client_name'], $_POST['t_name'], $_POST['p_lan'], $_POST['p_client_mob'], $_POST['p_status'], $_FILES['com_img']['name'], $pid);
                    } else {
