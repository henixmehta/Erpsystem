                                        ...
                                        <table id="user-list-table" class="table table-striped" role="grid" data-bs-toggle="data-table">
                                            ...
                                            <tbody>
                                                ...
                                                if (isset($_POST['search'])) {
                                                    ...
                                                    $q = "SELECT * FROM Holiday WHERE hname LIKE '%$search%' OR sdate LIKE '%$search%' OR edate LIKE '%$search%' OR types LIKE '%$search%' ";
                                                } else {
                                                    ...
                                                    <tr>
                                                        ...
                                                        ?>
                                                            <td>
                                                                ...
                                                                <!-- delete button -->
                                                                <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" href="Holiday-delete.php?id=<?php echo $row['id'] ?>">
                                                                    <span class="btn-inner">
