...
<head>
   ...
   if (isset($_POST['sub_btn_update'])) {
      ...
      $q = "UPDATE employee SET 
                        ...
                        e_bdate='" . $_POST['e_bdate'] . "', e_country='" . $_POST['country'] . "', e_state='" . $_POST['e_state'] . "', 
                        ...
                        <form method="POST" enctype="multipart/form-data">
                           ...
                           <div class="row">
                              <div class="form-group col-md-6">
                                 ...
                                 <!-- <span class="error"><?php // echo $e_fname; 
                                                            ?></span>                              -->
                              </div>
                              ...
                              <div class="form-group col-md-6">
                                 ...
                                 <!-- <span class="error"><?php // echo $e_lname; 
                                                            ?></span>    -->
                              </div>
                              ...
                              <div class="form-group">
                                 ...
                                 <select class="selectpicker form-control" name="e_role" data-style="py-0" required>
                                    ...
                                    $query1 = "SELECT id, role_name, r_status FROM role"; // Include id in the query to get the role's ID
                                    ...
                                    if (mysqli_num_rows($result_role) > 0) {
                                       while ($role_row = mysqli_fetch_assoc($result_role)) {
                                          if ($role_row['r_status'] == "active") {
                                             // Check if the fetched role ID matches the employee's current role ID
                                             $selected = ($row['e_role'] == $role_row['id']) ? 'selected' : '';
                                             // Output the option with the role's name and set 'selected' if it matches the employee's current role
                                             echo "<option value='" . $role_row['id'] . "' " . $selected . ">" . $role_row['role_name'] . "</option>";
                                          }
                                       }
                                    }
                                    ?>
                              ...
                              <div class="form-group col-md-12">
                                 ...
                                 <input type="date" class="form-control" name="e_bdate" id="bdate" placeholder="Enter your Birthday" value=<?php echo $row['e_bdate']; ?> required>
                                 <!-- <span class="error"><?php // echo $e_lname; 
                                                            ?></span>    -->
                              </div>
                              ...
                              <div class="form-group col-md-12">
                                 ...
                                 <?php if (isset($row['e_deg'])) { ?>
                                    <div>Old : <?php echo $row['e_deg']; ?></div>
                              ...
                              <div class="form-group col-md-12">
                                 ...
                                 <?php if (isset($row['e_resume'])) { ?>
                                    <div>Old : <?php echo $row['e_resume']; ?></div>
                                    <input type="hidden" name="old_resume" value="<?php echo $row['e_resume']; ?>">
                                 <?php } ?>
                              </div>
