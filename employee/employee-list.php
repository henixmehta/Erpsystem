                                 ...
                                 <table id="user-list-table" class="table table-striped" role="grid" data-bs-toggle="data-table">
                                    ...
                                    <tbody>
                                       ...
                                       if (isset($_POST['search'])) {
                                          ...
                                          $q = "SELECT * FROM employee WHERE e_fname LIKE '%$search%' OR e_lname LIKE '%$search%' OR e_team_name LIKE '%$search%' OR e_mob LIKE '%$search%' OR e_alt_mob LIKE '%$search%' OR e_email LIKE '%$search%' OR e_com_email LIKE '%$search%' OR e_role LIKE '%$search%'";
                                       } else {
