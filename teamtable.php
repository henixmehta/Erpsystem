                  ...
                  <table id="user-list-table" class="table table-striped" role="grid" data-bs-toggle="data-table">
                     ...
                     <?php
                        ...
                        <td>
                           ...
                           <!-- update -->
                              <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-original-title="Edit" href="teamupdate.php?id=<?php echo $row['id']?>">
                              ...
                              <!-- delete button -->            
                              <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"  href="teamdelete.php?id=<?php echo $row['id']?>" >
                                 <span class="btn-inner">
